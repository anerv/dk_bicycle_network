...
function osm2pgsql.select_relation_members(relation)
    ...
    if relation.tags.type == 'route' and relation.tags.ref then -- and relation.tags.route == 'road'
...
function osm2pgsql.process_relation(object)
    if object.tags.type == 'route' and object.tags.ref then --and object.tags.route == 'bus'
        tables.routes:insert({
            tags = object.tags,
            type = object.tags.type, -- new column
            ref = object.tags.ref, -- new column
            route = object.tags.route, -- new column
            name = object.tags.name, -- new column
            network = object.tags.network -- new column
        })
